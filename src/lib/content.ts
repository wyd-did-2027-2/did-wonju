...
export const content = {
  kr: {
    ...
    metadata: {
      ...
      description: "원주교구에서 열리는 교구대회(DID) 프로그램 안내, 참가 신청, 홈스테이 및 봉사자 정보를 확인하세요. 전 세계 청년들과 함께하는 신앙의 축제가 시작됩니다.",
      keywords:
  ...
  en: {
    ...
    popup: {
      ...
      description:
        "Check out the latest news about WYD from the Diocese of Wonju.",
    },
  },
} as const;
